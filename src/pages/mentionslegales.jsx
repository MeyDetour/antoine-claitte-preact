...
<p>Propriétaire du site : Claitte Antoine - Contact : contact@antoineclaitte.com 0651484225 - Adresse : 101 Chemin de Ronde.</p>
					...
					<p>Directeur de la publication : Antoine - Contact : contact@antoineclaitte.com.</p>
					...
					<p>Autres contributeurs : Mey DETOUR</p>
				</div>

				<div>
					<h3>2. Propriété intellectuelle et contrefaçons.</h3>
					<p>Claitte Antoine est propriétaire des droits de propriété intellectuelle et détient les droits d’usage sur tous les éléments accessibles sur le site internet, notamment les textes, images, graphismes, logos, vidéos, architecture, icônes et sons.</p>
				...
				<div>
					...
					<p>Le cas échéant, Claitte Antoine se réserve également la possibilité de mettre en cause la responsabilité civile et/ou pénale de l’utilisateur, notamment en cas de message à caractère raciste, injurieux, diffamant, ou pornographique, quel que soit le support utilisé (texte, photographie …).</p>
				</div>
				<div>
